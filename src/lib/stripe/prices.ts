...
export const PRICING_TIERS: Record<PricingTier, TierConfig> = {
  founding: {
    ...
    description:
      "First-5-customer tier with 12-month rate lock and testimonial reciprocity",
    monthlyPrice: 299,
    ...
    features: [
      ...
      "Founding-customer badge on /companies/[slug]",
      "Direct line to founder for support",
      "Co-marketing testimonial in exchange",
    ],
  ...
  starter: {
    ...
    description: "DSOs with 10–20 practices, up to 25 active listings",
    monthlyPrice: 499,
    monthlyPriceCents: 49900,
    features: [
      "Up to 25 active job listings",
      "Multi-location posting",
      "Application kanban + status tracking",
  ...
  growth: {
    ...
    description: "DSOs with 20–35 practices, unlimited listings",
    monthlyPrice: 999,
    monthlyPriceCents: 99900,
    features: [
      "Unlimited active job listings",
      "Multi-location posting + custom branding",
