...
const ROUTES: Record<string, RouteDef> = {
  ...
  candidate_resume: { scope: "candidate", path: () => "/candidate/resume", label: "Open your resume" },
  candidate_resume_build: { scope: "candidate", path: () => "/candidate/resume/build", label: "Open the resume builder" },
