...
export function OpenSupportButton() {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex items-center gap-1.5 rounded-md bg-primary text-primary-foreground px-3.5 py-2 text-2xs font-bold tracking-[1.5px] uppercase hover:bg-primary/90"
    >
