              ...
              {CLOSED_TRANSITIONS.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={`block w-full text-left px-4 py-2.5 text-xs font-semibold transition-colors focus:outline-none focus-visible:bg-cream disabled:opacity-50 disabled:cursor-not-allowed ${
                      t.tone === "danger"
