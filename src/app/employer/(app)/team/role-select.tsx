  ...
  return (
    <form action={changeTeammateRole} className="flex items-center">
      ...
      <select
        ...
        className="px-3 py-2 bg-cream border border-[var(--rule-strong)] text-ink text-xs font-semibold tracking-[0.5px] uppercase focus:outline-none focus:border-heritage focus:ring-1 focus:ring-heritage transition-colors cursor-pointer"
      >
