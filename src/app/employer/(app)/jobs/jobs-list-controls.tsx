        ...
        <div className="relative">
          ...
          {locOpen && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-1 z-30 w-[280px] max-w-[calc(100vw-2rem)] max-h-[360px] overflow-y-auto bg-popover border border-[var(--rule-strong)] shadow-2">
                <div className="px-3 py-2 border-b border-[var(--rule)] flex items-center justify-between">
                  ...
                  {activeLocCount > 0 && (
                    <button
                      ...
                      className="text-2xs font-bold tracking-[1.2px] uppercase text-slate-meta hover:text-danger"
                    >
                      Clear
                    </button>
                  )}
          ...
          {activeLocationIds.map((id) => {
            ...
            return (
              <button
                ...
                className="inline-flex items-center gap-1 px-2 py-0.5 bg-heritage/10 border border-heritage/30 text-2xs font-bold tracking-[0.5px] text-heritage-deep hover:bg-heritage/20"
              >
                {loc.name}
