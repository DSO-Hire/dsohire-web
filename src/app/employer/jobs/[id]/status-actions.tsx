        ...
        .map((b) => (
          <form key={b.targetStatus} action={action}>
            ...
            <button
              type="submit"
              disabled={pending}
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-[var(--rule-strong)] text-ink text-[11px] font-bold tracking-[1.5px] uppercase hover:bg-ink hover:text-ivory hover:border-ink transition-colors disabled:opacity-60"
            >
