...
const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Two audiences, one platform. Dental groups: multi-location operators and DSOs who post roles and hire across their practices. Professionals: everyone in dentistry — dentists, specialists, hygienists, assistants, front-office staff, and corporate/DSO roles. It's purpose-built for multi-location groups; a single-location office can use it, but the multi-location backbone is where it shines.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Your application goes directly to the hiring team at the dental group — no recruiter in between. You'll get status updates in your candidate dashboard and by email as they review, interview, and decide.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes — this is core to why we exist. You can hide your profile from any group you list as a current employer, and it's enforced automatically. Working hygienists tell us it's the number-one reason they hesitate to job-search; DSO Hire is built so a confidential search stays confidential.",
      },
      {
