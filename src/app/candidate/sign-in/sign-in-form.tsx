...
import { signInCandidate, type CandidateSignInState } from "./actions";

const initial: CandidateSignInState = { ok: false };

export function CandidateSignInForm({ next }: { next?: string }) {
  const [state, action, pending] = useActionState(signInCandidate, initial);
