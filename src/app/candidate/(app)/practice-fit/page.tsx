...
import { JobPreferencesForm } from "@/app/candidate/(app)/settings/job-preferences/job-preferences-form";
import { PracticeFitSection } from "@/app/candidate/(app)/settings/privacy/privacy-form";
