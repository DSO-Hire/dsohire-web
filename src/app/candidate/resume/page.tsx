...
export default async function CandidateResumePage() {
  ...
  // No résumé on file yet → a friendly two-path landing (kept INSIDE the
  // candidate shell so the nav stays; the print-clean standalone view below is
  // only for an actual rendered résumé). Build-for-free is the emphasized path.
  if (sparse) {
    return (
      <CandidateShell active="resume">
