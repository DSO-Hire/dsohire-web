...
export function RailCollapse({
  ...
  return (
    <button
      ...
      className="absolute top-8 -right-px z-10 flex h-[34px] w-[18px] items-center justify-center border border-r-0 border-sidebar-border bg-sidebar-foreground/[0.08] text-2xs text-sidebar-foreground/60 transition-colors hover:bg-heritage-deep hover:text-sidebar-foreground"
    >
      {slim ? "›" : "‹"}
    </button>
  );
