    ...
    <div className="flex h-full min-h-0 flex-col overflow-y-auto bg-cream/30 px-4 py-4 space-y-4">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-2xs text-slate-meta leading-snug">
            {jobTitle}
          </p>
          {locationName && (
            <p className="mt-0.5 flex items-center gap-1 text-2xs text-slate-meta">
          ...
          <Link
            ...
            className="mt-1 inline-flex items-center gap-1 text-2xs font-semibold text-heritage-deep hover:text-ink underline-offset-2 hover:underline transition-colors"
          >
            Open application
      ...
      {replyRhythm && (
        <div className="flex items-center gap-2 border border-[var(--rule)] bg-card px-3 py-2">
          ...
          <p className="text-2xs text-slate-body leading-snug">
      ...
      <div className="border border-[var(--rule)] bg-card px-3 py-3">
        ...
        {terminal && (
          <p className="mt-2 border-t border-[var(--rule)] pt-2 text-2xs font-semibold text-slate-meta">
      ...
      {notesCount > 0 && (
        <p className="text-2xs text-slate-meta px-0.5">
      ...
      <div className="border border-dashed border-[var(--rule)] bg-card/60 px-3 py-2.5">
        <p className="flex items-center gap-1.5 text-2xs font-bold tracking-[1.5px] uppercase text-slate-meta">
