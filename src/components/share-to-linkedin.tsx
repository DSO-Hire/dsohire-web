...
export function ShareToLinkedIn({
  ...
  return (
    <a
      ...
      className={
        className ??
        "inline-flex items-center justify-center gap-2 px-6 py-3.5 border border-[var(--rule-strong)] bg-card text-ink text-xs font-bold tracking-[2px] uppercase hover:bg-cream transition-colors"
      }
    >
      <svg
        viewBox="0 0 24 24"
