            ...
            >
              ...
              {item.badge && item.badge > 0 ? (
                <span
                  ...
                  className="rail-badge ml-2 inline-flex items-center justify-center rounded-full bg-heritage-deep px-1.5 py-0.5 text-2xs font-bold text-primary-foreground min-w-[18px]"
                >
