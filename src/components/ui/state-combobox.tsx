...
// Re-export so existing client-component callers that imported these from
// state-combobox keep working without churn. The canonical home is
// @/lib/us-states (server-safe). Server Components MUST import from
// @/lib/us-states directly — importing them through this "use client" file
// breaks RSC boundary rules.
export { US_STATES, normalizeStateInput, type StateOption } from "@/lib/us-states";
